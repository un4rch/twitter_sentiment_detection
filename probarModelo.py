...
if __name__ == '__main__':
    ...
    testX, target_map = preprocessor.preprocessDataset(testX, targetColumnName, algorithm, excludedColumns, imputeOption, rescaleOption, NLcolumns, NLtechnique, "test")
    target_map_reves = {}
